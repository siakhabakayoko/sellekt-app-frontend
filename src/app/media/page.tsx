...
import { FaFacebookF,FaFacebookMessenger, FaTwitter, FaInstagram, FaLinkedinIn, FaRegHandPointRight, FaHourglassStart, FaTimes, FaTicketAlt, FaCalendarTimes, FaUserTimes, FaRegTimesCircle, FaRegCalendarTimes } from 'react-icons/fa';
import { FaBusinessTime, FaHouseCircleCheck, FaRegMessage, FaTimeline } from 'react-icons/fa6';
               ...
               <Squircle
                ...
                >
                  <Link href="#linkedin" className="social-icon">
                    <FaRegMessage size={20} color="#FCD514" />
                  </Link>
                </Squircle>
                <span style={{marginLeft:"7px",color:'#6A5908',fontWeight:900}}>112</span>
        ...
        <Squircle
          ...
          >
               <Squircle
                ...
                >
                  <Link href="#linkedin" className="social-icon">
                    <FaRegHandPointRight size={20} color="#FF5C14" />
                  </Link>
                </Squircle>
                <span style={{marginLeft:"7px",color:'#6B2708',fontWeight:900}}>112</span>
        ...
        <Squircle
          ...
          >
               <Squircle
                ...
                >
                  <Link href="#linkedin" className="social-icon">
                    <FaRegCalendarTimes size={20} color="#00D4AE" />
                  </Link>
                </Squircle>
                <span style={{marginLeft:"7px",color:'#003B33',fontWeight:900}}>112</span>
...
const BlogPage = () => {
  const blogPosts = [
    ...
    {
      icon: '/images/sourir.png',
      title: 'Manger sainement sans se priver',
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute...',
      category: 'Nutrition & Diét'
    },
    {
      icon: '/images/taille sourir.png',
      title: 'Quelques routines matinales',
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute...',
      category: 'Exercices'
    },
    {
      icon: '/images/sajw.png',
      title: 'Comment perdre du poids',
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute...',
      category: 'Santé & Bien-être'
    },
    {
      icon: '/images/sqts.png',
      title: 'Manger sainement sans se priver',
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute...',
      category: 'Nutrition & Diét'
    },
    {
      icon: '/images/sssa.png',
      title: 'Quelques routines matinales',
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute...',
      category: 'Exercices'
    }
        ...
        <main style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Explorez nos variétés de contenus multimédias conçus spécialement pour vous aider à améliorer votre bien-être.
            </p>
